...
class ChessPiece:
    ...
    def storeboardset():
        ...
        for i in self._moveset:
            if board[i][0].lower() == self._piece[0]:
                self._defending.append(i)
            elif board[i][0].lower() != " ":
                self._attacking.append(i)
        for i in storeboard[self._space]:
            if board[i][0].lower() == self._piece[0]:
                self._defended_by.append(i)
            elif board[i][0].lower() != " ":
...
if __name__ == "__main__":
    ...
    print(f"The piece {piece} is on {chesspiece.space"}
